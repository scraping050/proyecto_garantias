    ...
    return (
        <div className="min-h-screen bg-slate-50 p-4 dark:bg-slate-900 sm:p-6 lg:p-8">
            <div className="mx-auto w-full max-w-[95%] space-y-8">
                ...
                {/* Filters */}
                <div className="rounded-2xl border border-slate-200/60 bg-white/50 p-6 shadow-sm dark:border-slate-700/60 dark:bg-slate-800/50 bg-backdrop-blur-xl">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            className="rounded-lg border-0 bg-white py-1.5 pl-3 pr-8 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 focus:ring-2 focus:ring-indigo-600 dark:bg-slate-800 dark:text-slate-200 dark:ring-slate-700"
                            value={itemsPerPage}
